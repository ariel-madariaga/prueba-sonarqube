                        ...
                        <v-card-text class="mt-12">
                            ...
                            <v-form>
                                <v-text-field label="Correo electrónico" v-model="inicioSesion.email" type="text"
                                    color="blue darken-1"
                                    :error-messages="emailInicioErrors"
                                    required
                                    @input="$v.inicioSesion.email.$touch()"
                                    @blur="$v.inicioSesion.email.$touch()"  />

                                <v-text-field id="password" label="Contraseña" v-model="inicioSesion.password" type="password"
                                    color="blue darken-1"
                                    :error-messages="passwordInicioErrors"
                                    required
                                    @input="$v.inicioSesion.password.$touch()"
                                    @blur="$v.inicioSesion.password.$touch()" />
                            </v-form>
                        </v-card-text>
                        <div class="text-center mt-3">
                            <v-btn type="submit" rounded color="blue darken-1" dark @click="iniciarSesion()">Iniciar sesión</v-btn>
                        </div>
                    </div>
                </v-col>
                ...
                <v-col cols="12" md="8">
                    <div class="formulario">
                        <v-card-text class="mt-12">
                            ...
                            <v-form>
                                <v-text-field 
                                    ...
                                    @blur="$v.nombre.$touch()" 
                                    v-model="nombre" type="text"
                                    color="blue darken-1" />
                                <v-text-field :error-messages="apellidoErrors"
                                    label="Apellido"
                                    required
                                    @input="$v.apellido.$touch()"
                                    @blur="$v.apellido.$touch()" 
                                    v-model="apellido" type="text"
                                color="blue darken-1" />
                                <v-text-field :error-messages="rutErrors"
                                    label="rut"
                                    required
                                    @input="$v.rut.$touch()"
                                    @blur="$v.rut.$touch()" 
                                    v-model="rut" type="text"
                                color="blue darken-1" />
                                <v-text-field :error-messages="correoErrors"
                                v-model="email" 
                                type="text"    
                                label="E-mail"
                                    required
                        ...
                        <div class="text-center mt-4">
                            <v-btn type="submit" rounded color="blue darken-1" dark @click="registro()">Registrate</v-btn>
                        </div>
                    </div>
                </v-col>
            </div>
